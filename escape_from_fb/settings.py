"""
Django settings for escape_from_fb project.
...
ROOT_URLCONF = 'escape_from_fb.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'escape_from_fb', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'escape_from_fb.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'escape_from_fb', 'static'),
)
